...
########## FastSurfer segmentation ###############################################
    if fastsurfer:
        ...
        #    to_native_space(fs_seg_file, fs_seg_file_nifti)
            ...
            command += f' --network_coronal_path {os.path.join(fs_dir, "checkpoints/Coronal_Weights_FastSurferCNN/ckpts/Epoch_30_training_state.pkl")}'
            command += f' --network_axial_path {os.path.join(fs_dir, "checkpoints/Axial_Weights_FastSurferCNN/ckpts/Epoch_30_training_state.pkl")}'
